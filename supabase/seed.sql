...
INSERT INTO bin_compartments (bin_id, compartment_index, label, current_fill_level, current_weight_kg, waste_count, classification) VALUES
  ('c0000000-0000-4000-8000-000000000001', 0, 'Recyclable', 40, 8.5, 120, '{"plastic": 50, "paper": 40, "metal": 30}'),
  ('c0000000-0000-4000-8000-000000000001', 1, 'Non-Recyclable', 51, 10.2, 85, '{"organic": 45, "other": 40}'),
  ('c0000000-0000-4000-8000-000000000003', 0, 'Recyclable', 25, 4.0, 60, '{"plastic": 30, "paper": 30}'),
  ('c0000000-0000-4000-8000-000000000003', 1, 'Non-Recyclable', 35, 5.5, 40, '{"organic": 25, "other": 15}'),
  ('c0000000-0000-4000-8000-000000000005', 0, 'Recyclable', 95, 18.0, 200, '{"plastic": 80, "paper": 70}'),
  ('c0000000-0000-4000-8000-000000000005', 1, 'Non-Recyclable', 89, 15.0, 150, '{"organic": 90, "other": 60}')
ON CONFLICT DO NOTHING;

-- Compartments for 4-bin units
INSERT INTO bin_compartments (bin_id, compartment_index, label, current_fill_level, current_weight_kg, waste_count, classification) VALUES
  ('c0000000-0000-4000-8000-000000000002', 0, 'Plastic', 75, 6.0, 80, '{"plastic": 80}'),
  ('c0000000-0000-4000-8000-000000000002', 1, 'General', 85, 7.5, 95, '{"general": 95}'),
  ('c0000000-0000-4000-8000-000000000002', 2, 'Paper', 70, 5.0, 45, '{"paper": 45}'),
  ('c0000000-0000-4000-8000-000000000002', 3, 'Metal', 98, 12.0, 110, '{"metal": 110}'),
  ('c0000000-0000-4000-8000-000000000004', 0, 'Plastic', 50, 4.0, 40, '{"plastic": 40}'),
  ('c0000000-0000-4000-8000-000000000004', 1, 'General', 55, 4.5, 50, '{"general": 50}'),
  ('c0000000-0000-4000-8000-000000000004', 2, 'Paper', 60, 5.0, 35, '{"paper": 35}'),
  ('c0000000-0000-4000-8000-000000000004', 3, 'Metal', 55, 6.0, 55, '{"metal": 55}'),
